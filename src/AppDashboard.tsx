/**
 * Dashboard application - authenticated product experience
  ...
  return (
    <div className="flex h-screen bg-white overflow-hidden">
      <aside className="w-72 border-r border-gray-100 bg-white p-8 flex flex-col gap-10">
        ...
        <div className="pt-8 border-t border-gray-100 space-y-1.5">
          <SidebarItem icon={Settings} label="Settings" onClick={() => {}} />
          <Link
            to="/"
            className="flex items-center gap-3 px-4 py-2.5 w-full text-sm font-medium text-gray-500 hover:bg-gray-50 hover:text-[#111827] rounded-xl transition-all"
          >
            ← Back to site
          </Link>
        </div>
